...
/**
 * PointLight class represents a light source that emits light uniformly in all directions from a specific point in space.
 */
public class PointLight extends Light implements LightSource {
	...
	/**
	 * Constant attenuation coefficient for the point light.
	 * Controls how much the light diminishes with distance.
	 */
	private double kC = 1;

	/**
	 * Linear attenuation coefficient for the point light.
	 * Controls how much the light diminishes linearly with distance.
	 */
	private double kL = 0;

	/**
	 * Quadratic attenuation coefficient for the point light.
	 * Controls how much the light diminishes quadratically with distance.
	 */
	private double kQ = 0;
    ...
    /**
     * Returns the intensity of the light at a specified point in the scene, taking into account
    ...
    /**
     * Returns the direction vector from the light source to a specified point in the scene.
     * 
