...
public class LightsTests {
	...
	public void spherePoint() {
		...
		Camera camera5 = camera1.setImageWriter(new ImageWriter("lightSpherePoint", 500, 500)).build();
		camera5.renderImage();
		camera5.writeToImage();
	}
	...
	public void sphereSpot() {
		...
		Camera camera4 = camera1.setImageWriter(new ImageWriter("lightSphereSpot", 500, 500)).build();
		camera4.renderImage();
	...
	public void trianglesDirectional() {
		...
		Camera camera3 = camera2.setImageWriter(new ImageWriter("lightTrianglesDirectional", 500, 500)).build();
		camera3.renderImage();
	...
	public void trianglesPoint() {
		...
		Camera camera3 = camera2.setImageWriter(new ImageWriter("lightTrianglesPoint", 500, 500)).build();
		camera3.renderImage();
		camera3.writeToImage();
	}
...
//
//      Camera camera3 = camera1.setImageWriter(new ImageWriter("lightSphereSpotSharp", 500, 500)).build();
//      camera3.renderImage();
//      camera3.writeToImage();
//   }
//
...
//         .setKl(0.001).setKq(0.00004).setNarrowBeam(10));
//
//      Camera camera3 = camera2.setImageWriter(new ImageWriter("lightTrianglesSpotSharp", 500, 500)).build();
//      camera3.renderImage();
//      camera3.writeToImage();
//
//}
	...
	public void sphereMultipleLights() {
		scene1.geometries.add(sphere);
		scene1.lights.add(new DirectionalLight(new Color(500, 300, 100), new Vector(-1, -1, -1)));
		scene1.lights.add(new PointLight(new Color(300, 500, 200), new Point(50, 50, 100)).setKl(0.001).setKq(0.0002));
		scene1.lights.add(new SpotLight(new Color(200, 200, 500), new Point(-50, -50, 50), new Vector(1, 1, -2))
				.setKl(0.001).setKq(0.0001));

		Camera camera = camera1.setImageWriter(new ImageWriter("lightSphereMultiple", 500, 500)).build();
		camera.renderImage();
		camera.writeToImage();
	}
	...
	public void trianglesMultipleLights() {
		scene2.geometries.add(triangle1, triangle2);
		scene2.lights.add(new DirectionalLight(new Color(400, 300, 300), new Vector(1, -1, -2)));
		scene2.lights.add(new PointLight(new Color(300, 400, 300), new Point(-50, 50, 50)).setKl(0.001).setKq(0.0002));
		scene2.lights.add(new SpotLight(new Color(300, 300, 500), new Point(0, 0, 100), new Vector(-1, -1, -2))
				.setKl(0.001).setKq(0.0001));

		Camera camera = camera2.setImageWriter(new ImageWriter("lightTrianglesMultiple", 500, 500)).build();
		camera.renderImage();
		camera.writeToImage();
	}
