...
public class RenderTests {
	...
	public void renderTwoColorTest() {
		...
		// right
		Camera camera1 = camera.setImageWriter(new ImageWriter("base render test", 1000, 1000)).build();
		camera1.renderImage();
	...
	public void renderMultiColorTest() {
		...
		Camera camera1 = camera.setImageWriter(new ImageWriter("color render test", 1000, 1000)).build();
		camera1.renderImage();
