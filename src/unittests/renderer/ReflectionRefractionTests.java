...
public class ReflectionRefractionTests {
	...
	public void twoSpheres() {
		...
		Camera camera1 = cameraBuilder //
				.setLocation(new Point(0, 0, 1000)).setVpDistance(1000).setVpSize(150, 150) //
...
//				.setImageWriter(new ImageWriter("refractionTwoSpheres", 1, 1)) // debug
	...
	public void twoSpheresOnMirrors() {
		...
		Camera camera1 = cameraBuilder.setLocation(new Point(0, 0, 10000)).setVpDistance(10000).setVpSize(2500, 2500)
				.setImageWriter(new ImageWriter("reflectionTwoSpheresMirrored", 500, 500)).build();
		camera1.renderImage();
		camera1.writeToImage();
	}
	...
	public void trianglesTransparentSphere() {
		...
		Camera camera1 = cameraBuilder.setLocation(new Point(0, 0, 1000)).setVpDistance(1000).setVpSize(200, 200)
				.setImageWriter(new ImageWriter("refractionShadow", 600, 600)).build();
		camera1.renderImage();
		camera1.writeToImage();
	}
}
