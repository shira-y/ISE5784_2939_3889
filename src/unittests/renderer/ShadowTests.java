...
public class ShadowTests {
   ...
   private void sphereTriangleHelper(String pictName, Triangle triangle, Point spotLocation) {
     ...
     Camera camera1 = camera.setImageWriter(new ImageWriter(pictName, 400, 400))
         .build();
         camera1.renderImage(); //
   ...
   public void trianglesSphere() {
      ...
      Camera camera2 = camera.setImageWriter(new ImageWriter("shadowTrianglesSphere", 600, 600))
         .build();
      camera2.renderImage();
