...
public class ShadowTests {
	...
	private final Camera.Builder camera = Camera.getBuilder().setDirection(new Vector(0, 0, -1), new Vector(0, 1, 0))
			.setLocation(new Point(0, 0, 1000)).setVpDistance(1000).setVpSize(200, 200)
			.setRayTracer(new SimpleRayTracer(scene));

	/** The sphere in the tests */
	private final Intersectable sphere = new Sphere(new Point(0, 0, -200), 60d).setEmission(new Color(BLUE))
	...
	private void sphereTriangleHelper(String pictName, Triangle triangle, Point spotLocation) {
		...
		Camera camera1 = camera.setImageWriter(new ImageWriter(pictName, 400, 400)).build();
		camera1.renderImage(); //
	...
	public void trianglesSphere() {
		...
		Camera camera2 = camera.setImageWriter(new ImageWriter("shadowTrianglesSphere", 600, 600)).setRayTracer(new SimpleRayTracer(scene).setUseSoftShadow(true)).build();
		camera2.renderImage();
