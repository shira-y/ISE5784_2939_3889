...
class PlaneTests {
	...
	public void testFindIntersections() {
		...
		assertNull(plane.findIntsersections(ray2), "Ray does not cut the plane");
		...
		assertNull(plane.findIntsersections(ray3), "Ray is parallel and outside the plane");

		// TC04: Ray is parallel and inside the plane
		Ray ray4 = new Ray(new Point(0, 0, 1), new Vector(1, 0, 0));
		assertNull(plane.findIntsersections(ray4), "Ray is parallel and inside the plane");
		...
		List<Point> result2 = plane.findIntsersections(ray5);
		...
		assertNull(plane.findIntsersections(ray6), "Ray is perpendicular and starts inside the plane");

		// TC07: Ray is perpendicular and starts after the plane
		Ray ray7 = new Ray(new Point(0, 0, 2), new Vector(0, 0, 1));
		assertNull(plane.findIntsersections(ray7), "Ray is perpendicular and starts after the plane");
		...
		assertNull(plane.findIntsersections(ray8), "Ray starts inside the plane");

		// TC09: Ray starts at the reference point of the plane
		Ray ray9 = new Ray(new Point(0, 0, 1), new Vector(1, 1, 1));
		List<Point> result3 = plane.findIntsersections(ray9);
